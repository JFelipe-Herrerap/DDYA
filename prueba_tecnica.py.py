...
#Puntos #8, #9 y #10.
#Profesor Edwin, no logré desarrollar completamente los puntos 8,9 y 10 porque, aunque intenté comprender la lógica del procedimiento, aún tengo dificultades para aplicar
